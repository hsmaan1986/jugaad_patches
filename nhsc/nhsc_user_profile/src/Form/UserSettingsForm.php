...
class UserSettingsForm extends FormBase {
    ...
    public function buildForm(array $form, FormStateInterface $form_state) {
        ...
        $form['newsletter'] = [
            '#type' => 'checkbox',
            '#title' => $this->t('I want to receive N+ Hub notifications'),
        ...
        $cancel_url = Url::fromRoute('nhsc_user_profile.page_controller_homepage', [], ['absolute' => true]);
        $form['cancel'] = [
    ...
    public function getFormId() {
        return 'nhsc_user_profile_user_settings_form';
    }
