...
/**
 * Build Get Linkedin Feed settings form.
 */
class GetLinkedinFeedSettings extends ConfigFormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'nhsc_linked_in_feed_settings_form';
  }
  ...
  protected function getEditableConfigNames() {
    return ['nhsc_linked_in_feed.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['linkedin_pull']['linkedin_import'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Enable importing Linkedin Feed'),
    ...
    $form['linkedin_oauth']['redirect_uri'] = [
      ...
      '#markup' => Url::fromUri('base:admin/config/content/nhsc_linked_in_feed/token', ['absolute' => TRUE])
        ->toString(),
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('nhsc_linked_in_feed.settings')
      ->setData($values)
      ->save();
  ...
  public function getNewLinkedinToken(array &$form, FormStateInterface $form_state) {
    ...
    $config = $this->config('nhsc_linked_in_feed.settings');
