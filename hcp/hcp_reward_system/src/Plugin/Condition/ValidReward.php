...
/**
* Provides a 'Valid reward' condition to enable a condition based in module selected status.
*
* @Condition(
*   id = "valid_reward",
*   label = @Translation("Valid reward"),
*   context = {
*     "action" = @ContextDefinition("entity:action", required = TRUE , label = @Translation("action"))
*   }
* )
*
*/
class ValidReward extends ConditionPluginBase {
...
/**
 * Creates a new ValidReward object.
 *
